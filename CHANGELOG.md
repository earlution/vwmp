...
### Changed
- Updated Contributing section in README for open-source project
  - Added comprehensive step-by-step contribution guide
  - Included fork and pull request workflow
  - Added contribution guidelines (code quality, documentation, testing)
  - Added getting help section with links to discussions and issues
